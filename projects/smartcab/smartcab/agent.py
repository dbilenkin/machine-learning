...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        random_epsilon = random.random() < self.epsilon
        if (not self.learning or random_epsilon):
            action = random.choice(self.valid_actions)
        else:
            maxValue = max(actions.values())
            action = random.choice([k for k, v in actions.items() if v == maxValue])

        print 'epsilon: ', self.epsilon
        print 'random_epsilon: ', random_epsilon
